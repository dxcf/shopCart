<template>
  <div class="cart">
    ...
    <div class="cart-main">
      ...
      <div class="cart-body" v-for="(cart,index) in cartInfoList" :key="cart.id">
        <ul class="cart-list">
  ...
  export default {
    ...
    methods:{
      ...
      handler:throttle(async function(type,disNum,cart){
        ...
        // console.log('带给服务器变化量的数子',disNum)
        // 派发action
        try {
          // 代表的是修改成功
    ...
    computed:{
      ...
      // 判断底部复选框是否勾选【全部的产品全选中才勾选】
      isAllCheck(){
        // 遍历数组里面的元素，只要全部元素isChecked属性都为1就为真，只要有一个不是就是假false
